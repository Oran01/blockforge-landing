 ...
 * Hero.tsx
 *
 * This is the main landing section for the homepage. It includes:
 * - A headline and CTA button
 * - A scroll hint indicator
 * - Scroll-reactive 3D visuals (icosahedron, cube, cuboid, torus) wrapped in <Circle> and <Hexagon>
 * - Dynamic animation using Framer Motion’s `useScroll` and `useTransform`
 *
 * @component
 * @returns JSX.Element
 */
    ...
    <section className="py-24 md:py-52 overflow-x-clip">
      <div className="container">
        ...
        <p className="text-center text-xl md:text-2xl mt-6 text-zinc-400 max-w-xl mx-auto">
          BlockForge is pioneering smart contract integrity with cutting-ege
          data solutions.
        </p>
        ...
        <div className="flex justify-center mt-24">
          <div className="inline-flex relative z-0">
            ...
            {/* Icosahedron (center, layered visual) */}
            <motion.div
