 ...
 * FeaturesGrid.tsx
 *
 * A two-section animated feature grid showcasing key messaging and visuals.
 * Each section contains dynamic scroll-based animations using Framer Motion,
 * paired with 3D illustrations and call-to-action buttons.
 *
 * The animations use `useScroll` and `useTransform` to create parallax-style
 * motion effects on different image layers as the user scrolls.
 *
 * Sections:
 * 1. Feature list with torus knot and mirrored hemisphere visuals.
 * 2. Supporting description with cone and hemisphere visuals.
 *
 * @component
 * @returns JSX.Element
 */
...
// Text-based bullet points for the left-hand feature section
const listItems = [
...
export const FeaturesGrid = () => {
  // === Refs and animations for 3D visuals ===

  // First section visuals (torus + hemisphere)
  ...
  // Second section visuals (cone + hemisphere)
    ...
    <section className="py-24 overflow-x-clip">
      <div className="container">
        <div className="flex flex-col gap-56 md:gap-48 lg:gap-80">
          {/* === Section 1: Feature list with visuals === */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="col-span-2">
              ...
              <p className="text-xl lg:text-2xl text-zinc-400 mt-8">
                Blockforge provide robust and secure infrastructure to support
              ...
              <ul className="flex flex-col gap-8 mt-12">
                {listItems.map((item) => (
                  <li key={item} className="flex items-center gap-3">
                    {/* Circular bullet with glowing accent */}
            ...
            {/* Right side 3D visuals (torus knot + hemisphere) */}
          ...
          {/* === Section 2: Supporting message with visuals === */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Left visuals: cone and second hemisphere */}
